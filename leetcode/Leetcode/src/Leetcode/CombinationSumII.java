...
public class CombinationSumII {
	public static void main(String[] args) {
		int[] r = { 2, 3, 6, 7 };
		System.out.print(combinationSum2(r, 7));
	...
	static void combinationSumRe(int[] candidates, int target, int start,
		...
		for (int i = start; i < candidates.length && target >= candidates[i]; ++i) {
			...
			combinationSumRe(candidates, target - candidates[i], i + 1, path,
					res);
